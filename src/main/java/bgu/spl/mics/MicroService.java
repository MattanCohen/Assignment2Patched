...
public abstract class MicroService implements Runnable {
    ...
    //MessageBusImpl.getInstance().complete(e,result);
        subscriptions.get(e.getClass()).call(result);
    }
...
//                    if (toDo.getClass()!= TickBroadcast.class)
//                    System.out.println(getName()+" is doing "+toDo.getClass()
//                            .toString().substring
//                                    (toDo.getClass().toString().lastIndexOf('.')+1));

                    subscriptions.get(toDo.getClass()).call(toDo);
                }catch(IllegalStateException | InterruptedException e){}
                catch (NullPointerException f){
//                    System.out.print(".."+getName()+"got null ....");
                }
            }
